...
/// <summary>Provides an equality comparer for dictionaries that determines equality based on their key-value pairs.</summary>
...
public class DictionaryEqualityComparer<TKey, TValue> : IEqualityComparer<Dictionary<TKey, TValue>>, System.Collections.IEqualityComparer
    where TKey : notnull
{
