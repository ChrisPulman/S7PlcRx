...
public interface IRxS7 : ICancelable
{
    ...
    /// <summary>Gets an observable sequence that provides notifications of the most recent error code encountered by the component.</summary>
    ...
    /// <summary>Observes changes to the specified variable and returns a sequence of its values as they are updated.</summary>
