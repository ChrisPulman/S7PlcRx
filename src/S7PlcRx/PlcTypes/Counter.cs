...
/// <summary>Provides static methods for converting between S7 Counter byte representations and <see cref="ushort"/> values.</summary>
...
public static class Counter
{
    ...
    /// <summary>Converts a sequence of bytes from the specified array, starting at the given index, to a 16-bit unsigned integer.</summary>
    ...
    /// <summary>Creates a 16-bit unsigned integer from two bytes, using the specified low and high byte values.</summary>
    ...
    /// <summary>Writes the specified 16-bit unsigned integer value to the provided span in big-endian byte order.</summary>
