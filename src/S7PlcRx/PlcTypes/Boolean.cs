...
public static class Boolean
{
    ...
    /// <summary>Sets the value of a bit to 1 (true), given the address of the bit. Returns a copy of the value with the bit set.</summary>
    ...
    /// <summary>Resets the value of a bit to 0 (false), given the address of the bit. Returns a copy of the value with the bit cleared.</summary>
    /// <param name="value">The input value to modify.</param>
