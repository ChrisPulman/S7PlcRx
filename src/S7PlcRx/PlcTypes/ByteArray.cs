...
/// <summary>Provides a dynamically sized buffer for accumulating bytes, with efficient memory management using array pooling.</summary>
...
public class ByteArray(int size) : IDisposable
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ByteArray"/> class with a default capacity of 32 bytes.</summary>
    ...
    /// <summary>Resets the current position to the beginning, effectively clearing any progress or state tracked by the instance.</summary>
    ...
    /// <summary>Ensures that the internal buffer has at least the specified capacity, expanding it if necessary.</summary>
