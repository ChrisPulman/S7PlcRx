...
public static class Int
{
    ...
    /// <summary>Converts a sequence of bytes from the specified array, starting at the given index, to a 16-bit signed integer.</summary>
    ...
    /// <summary>Writes the specified 16-bit signed integer value to the provided span in big-endian byte order.</summary>
    ...
    /// <summary>Writes the contents of a span of 16-bit signed integers to a span of bytes in little-endian order.</summary>
