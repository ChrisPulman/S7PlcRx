...
/// <summary>Provides methods and constants for converting between S7 PLC time representations and .NET <see cref="T:System.TimeSpan"/> values.</summary>
...
{
    /// <summary>Represents the size, in bytes, of the type.</summary>
    public const int TypeLengthInBytes = 4;

    /// <summary>Represents the minimum allowable value for a specification time span, defined as the number of milliseconds equal to <see cref="int.MinValue"/>.</summary>
    ...
    /// <summary>Creates a TimeSpan from a read-only span of bytes representing a 32-bit integer value in milliseconds.</summary>
    ...
    /// <summary>Converts the specified <see cref="System.TimeSpan"/> value to its binary representation as a byte array.</summary>
    ...
    /// <summary>Encodes the specified <see cref="System.TimeSpan"/> value into its S7 time representation and writes the result to the provided byte span.</summary>
    ...
    /// <summary>Converts a sequence of <see cref="System.TimeSpan"/> values to their binary representation and writes the result to the specified destination span.</summary>
