...
/// <summary>Specifies the supported variable types for data representation and communication with Siemens S7 PLCs.</summary>
...
internal enum VarType
{
    ...
    /// <summary>Represents a double-precision floating-point value, typically used for high-precision numerical calculations.</summary>
    LReal,
    ...
    /// <summary>Represents a simple counter that tracks a numeric value, typically used for counting occurrences or events.</summary>
    Counter,
    ...
    /// <summary>Represents a date and time value with extended range or precision compared to the standard <see cref="DateTime"/> structure.</summary>
